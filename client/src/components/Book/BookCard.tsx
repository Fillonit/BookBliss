...
export default function BookCard(book: BookCardProps) {
    return (
        <Card className="flex flex-col w-full max-w-xs mx-2 bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="relative">
                ...
                <span className="absolute bottom-0 right-0 bg-white text-amber-600 px-2 py-1 m-2 rounded">
                    {book.genre ?? 'None'}
                </span>
            </div>
