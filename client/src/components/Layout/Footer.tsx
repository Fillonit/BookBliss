...
<footer className="bg-white">
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center text-amber-900 sm:justify-start">
        ...
        <li>
            ...
            rel="noreferrer"
            target="_blank"
            className="text-amber-900 transition hover:text-amber-600/75"
        >
  ...
  <li>
    <a
      ...
      rel="noreferrer"
      target="_blank"
      className="text-amber-900 transition hover:text-amber-800/75"
    >
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        ...
        <div className="text-center sm:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start mt-8">
            <FontAwesomeIcon icon={faMapMarkerAlt} className="h-6 w-6 text-amber-700 transition hover:text-amber-800/75 mr-2" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start mt-2">
            <FontAwesomeIcon icon={faPhone} className="h-6 w-6 text-amber-700 transition hover:text-amber-800/75 mr-2" />
            <p className='w-full sm:w-auto text-center mt-2"'>(123) 456-7890</p>
          </div>
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start mt-2">
            <FontAwesomeIcon icon={faEnvelope} className="h-6 w-6 text-amber-700 transition hover:text-amber-800/75 mr-2" />
    ...
    <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        <p className="text-sm text-gray-500">
          ...
          <a
            className="inline-block text-amber-500 underline transition hover:text-amber-500/75"
            href="#"
          >
            Terms & Conditions
          </a>
